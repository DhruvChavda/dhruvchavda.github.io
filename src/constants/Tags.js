...
export const TAGS = {
  ...
  // LOKI: { name: "Loki", icon: Loki },
  HELM: { name: "Helm", icon: Helm },
  CFN: { name: "CloudFormation", icon: Aws },
  ...
  FLEXIBILITY: { name: "Flexibilidad y Adaptabilidad", icon: Flexibility },
  TEAMWORK: { name: "Trabajo en Equipo", icon: Team },
  INITIATIVE: { name: "Proactividad", icon: Iniciative },
  CRITIC: { name: "Pensamiento Crítico", icon: Critic },
  PROBLEMRES: { name: "Resolución de Problemas", icon: ProblemResolution },
  LEARN: { name: "Siempre Aprendiendo", icon: Learn },
